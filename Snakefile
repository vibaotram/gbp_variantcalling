...
rule filter_variants:
    ...
    shell:
        ...
        then
            ...
            vcftools --vcf $in_name"{params.vcftools_suf}.vcf" --out $in_name"{params.vcftools_suf}_singletons" --exclude-positions "{wildcards.chrom}.singletons" --recode --recode-INFO-all
